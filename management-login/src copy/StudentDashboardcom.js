...
function StudentDashboard({ student = dummyStudentData, onBackClick }) {
    ...
    return (
        <div className="dashboard-container">
            {/* Top Header Section */}
            <header>
                <div className="header-logo" onClick={onBackClick} style={{cursor:'pointer'}}>LOGO</div>
            </header>
            ...
            <section className="card main-stats-charts-section"> {/* New main container class */}
                ...
                <div className="charts-and-summary-grid"> {/* Grid for side-by-side charts */}
                    ...
                    <div className='chart-container chart-pie-specific'>
                        ...
                        <ResponsiveContainer width="100%" height={200} debounceDelay={1}>
                            <PieChart>
                                <Pie
