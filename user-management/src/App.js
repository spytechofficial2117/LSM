...
case 'permissionModifications':
            ...
            case 'batchUpdates':
                return <BatchUpdates users={users} updateUsers={updateUsers} removeUsers={removeUsers} />;
default:
                return <AccountCreation addUser={addUser} addUsers={addUsers} users={users} removeUsers={removeUsers} />;
}
    };
        ...
        <div className={`app-root ${isSidebarOpen ? 'sidebar-open-overlay' : ''}`}>
            <aside className={`sidebar ${isSidebarOpen ? 'open' : 'closed'}`}>
                ...
                <nav className="sidebar-links">
                    <SidebarLink pageName="accountCreation" 
icon={PlusSquareIcon} text="Account creation" />
